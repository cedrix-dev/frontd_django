...
path('signin/command/2',views.command), path('signin/command/10',views.btn10),path('signin/command/11',views.btn11),path('signin/command/12',views.btn12),path('signin/command/13',views.btn13),path('signin/command/14',views.btn14),path('signin/command/15',views.btn15),path('signin/command/16',views.btn16),path('signin/command/3',views.about),path('signin/command/5',views.register1),
